    ...
    def show_build_gt_environment(self):
        ...
        with col5:
            st.number_input(
                ...
                value=10 if "tng_test_percentage" not in st.session_state else st.session_state.tng_test_percentage,
        ...
        with col6:
            st.number_input(
                ...
                value=10 if "tng_dev_percentage" not in st.session_state else st.session_state.tng_dev_percentage,
