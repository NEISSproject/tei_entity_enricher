...
class Connector:
    def __init__(self, \
        ...
        loaded data can be passed to an instance of Cache class for further processing
    ...
    def get_gnd_data(self, data_selection: Union[str, List[str], None] = None) -> Union[dict, None]:
        ...
        def filter_received_data(gnd: str, mode: Union[str, List[str]]) -> dict:
            ...
            the keys of 'baseAliases' dict define the new key names, their value list denotates
