...
class GndConnector:
    ...
    def get_gnd_data(self, data_selection: Union[str, List[str], None] = None) -> Union[dict, None]:
        ...
        data_selection:
            ...
            (note yet implemented: can be a "person", "place", "organization" or a custom string refering to a user-defined set of keys, for which the mapping is provided in self.apilist)
        """
        if self.check_connectivity == False:
            print(
